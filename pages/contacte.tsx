  ...
  return (
    <>
      ...
      <div className="mt-20 flex justify-around items-center">
        <div className="p-5 shadow-custom transform hover:-translate-y-2 transition-all duration-500 ease-in-out">
        ...
        <div className="text-center p-5 shadow-custom transform hover:-translate-y-2 transition-all duration-500 ease-in-out">
        ...
        <div className="p-5 shadow-custom transform hover:-translate-y-2 transition-all duration-500 ease-in-out">
          <h1 className="text-xl font-semibold mb-7">TELEFON ȘI E-MAIL</h1>
          <Link
  ...
  <div className="text-left">
    ...
    <ul className="mb-3">
      <li>
       ...
       <span className="font-semibold text-[#D43E48]"> 16:00</span> și <span className="font-semibold text-[#D43E48]">18:00</span>.
      </li>
      <li>
        -În celelalte zile lucrătoare, suntem disponibili pentru tine între
        orele <span className="font-semibold text-[#D43E48]"> 10:00</span>  și <span className="font-semibold text-[#D43E48]">18:00</span>.
      </li>
    </ul>
    <p className="mx-auto mb-3">
    ...
    <p className="mx-auto">
      ...
      departamentul nostru de asistență tehnică la numărul de telefon
      <span className="font-semibold text-[#D43E48]"> 069 111 401</span> sau prin e-mail la
      adresa:
      <span className="font-semibold text-[#D43E48]"> sanduta.art@gmail.com.</span>
    </p>
  </div>
</div>
